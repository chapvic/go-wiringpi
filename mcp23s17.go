...
// Create a new instance of an MCP23s17 SPI GPIO interface.
// We know it has 16 pins, so all we need to know here is the SPI address and the user-defined pin base.
